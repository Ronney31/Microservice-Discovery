...
public class DepartmentController {
    ...
    public DepartmentController(RestTemplate restTemplate, @Value("${employee.service.url}") String employeeServiceUrl) {
    ...
    @RequestMapping("/{deptId}/employees")
    public ResponseEntity<Map<String, Object>> getDepartmentWithEmployees(@PathVariable int deptId) {
        Department department = findDepartmentByParam(deptId);
        if (department == null) {
